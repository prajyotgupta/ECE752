...
if [[ "$ARGC" != 3 ]]; then # Bad number of arguments.
   ...
   echo ""
        echo "Author: Adarsh and Vanshika"
        echo "amittal26@wisc.edu and vbaoni@wisc.edu"
        echo ""
